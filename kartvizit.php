...
$sqlCumle="SELECT * FROM `kullanici_kart` WHERE `kullanici_pr`=?;";
$stmt = $db->prepare($sqlCumle);
$stmt->execute([$kullaiciPR]);
$blockRow = $stmt->fetch(PDO::FETCH_ASSOC);
if(is_array($blockRow) && empty($blockRow)==false) {
    $userData=json_decode($blockRow["data"],true);
...
<head>
    ...
    <script>
        const UserCardData=<?php echo json_encode($userData); ?>;
                    ...
                    <div class="page-header-content pt-4">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mt-4">
                                ...
                                <div class="page-header-subtitle">Dynami form components to give your users informative and intuitive inputs</div>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="sbp-preview-content">
                                            ...
                                            <nav>
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <button class="nav-link active" id="nav-iletisim-tab" data-bs-toggle="tab" data-bs-target="#nav-iletisim" type="button" role="tab" aria-controls="nav-iletisim" aria-selected="true">İletişim</button>
                                                    <button class="nav-link" id="nav-ilan-tab" data-bs-toggle="tab" data-bs-target="#nav-ilan" type="button" role="tab" aria-controls="nav-ilan" aria-selected="false">İlan</button>
                                                    <button class="nav-link" id="nav-sosyalMedya-tab" data-bs-toggle="tab" data-bs-target="#nav-sosyalMedya" type="button" role="tab" aria-controls="nav-sosyalMedya" aria-selected="false">Sosyal Medya</button>
                                                    <button class="nav-link" id="nav-bankaBilgi-tab" data-bs-toggle="tab" data-bs-target="#nav-bankaBilgi" type="button" role="tab" aria-controls="nav-bankaBilgi" aria-selected="false">Banka Bilgileri</button>
                                                </div>
                                            </nav>
                                            <div class="tab-content" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="nav-iletisim" role="tabpanel" aria-labelledby="nav-iletisim-tab">
                                                    <form method="post" id="iletisimFrm" >
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <input class="form-control" id="Telefon"   name="Telefon" type="tel" >
                                                        ...
                                                        <div id="iletisim-cevap" class="mt-3 alert-success p-2"></div>

                                                        <div class="mt-3">
                                                            <button class="btn btn-primary btn-sm" type="button" id="iletisimGonder"  >Gönder</button>
                                                        </div>

                                                    </form>
                                                </div>
                                                <div class="tab-pane fade" id="nav-ilan" name="nav-ilan" role="tabpanel" aria-labelledby="nav-ilan-tab">
                                                    <div id="ilan-cevap" class="mt-3 alert-success p-2"></div>
                                                    <form id="ilanFrm" method="post">
                                                        <div class="mb-0" >
                                                            <label for="HespiEmlak">Hepsi Emlak</label>
                                                            <input class="form-control" id="HepsiEmlak" name="HepsiEmlak" type="text">
                                                        </div>
                                                        <div class="mb-0">
                                                            <label for="Sahibinden">Sahibinden</label>
                                                            <input class="form-control" id="Sahibinden" name="Sahibinden" type="text">
                                                        </div>
                                                        <div class="mb-0">
                                                            <label for="Zingat">Zingat</label>
                                                            <input class="form-control" id="Zingat"   name="Zingat" type="text">

                                                        </div>
                                                        <div class="mb-0">
                                                            <label for="EmlakJet">EmlakJet</label>
                                                            <input class="form-control" id="EmlakJet" name="EmlakJet" type="text">

                                                        </div>


                                                        <div class="mt-3">
                                                            <button class="btn btn-primary btn-sm" type="button" id="ilanGonder" >Gönder</button>
                                                        </div>
                                                    </form>

                                                </div>
                                                <div class="tab-pane fade" id="nav-sosyalMedya" role="tabpanel" aria-labelledby="nav-sosyalMedya-tab">
                                                    <form id="sosyalFrm" method="post" class="mt-3">
                                                        <div id="sosyal-cevap" class="mt-3 alert-success p-2"></div>
                                                        <div class="mb-0" >
                                                        ...
                                                        <div class="mt-3">
                                                            <button class="btn btn-primary btn-sm" type="button" id="SosyalMedyaGonder" >Gönder</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="tab-pane fade" id="nav-bankaBilgi" role="tabpanel" aria-labelledby="nav-bankaBilgi-tab">
                                                    <form id="idFrmBankaListe" onsubmit="false">
                                                        <div class="form-group mt-3" >
                                                            <label for="bankaSec">Bankanızı Seçiniz.</label>
                                                            <select name="bankaSec" id="bankaSec" class="form-control" required >
                                                                ...
                                                                <option value="ODA">ODA Bank</option>
                                                                <option value="Finans">ONB Finansbank</option>
                                                                <option value="Diger">Diğer</option>


                                                            </select>
                                                            <div class="mb-2 mt-3">
                                                                <label for="Iban" >Iban Numaranızı Giriniz.</label>
                                                            <input class="form-control " type="text" name="Iban" id="Iban" >
                                                            <button type="button"  class="btn btn-primary btn-sm mt-2" id="IbanEkle" >Ekle</button>
                                                            </div>
                                                            <br>
                                                            <label for="IbanList" > Eklenen Iban Listesi</label>

                                                            <div id="IbanList" style="min-height: 200px; max-height: 200px; border:1px solid #c5ccd6; border-radius: 0.35rem; overflow: auto;" class="mt-3 p-5">
                                                            </div>
                                                            <div id="sonucalani" class="mt-3 alert-success p-2" >
                                                            </div>
                                                            <button type="button" class="btn btn-warning btn-sm mt-2 listeyisil" id="IbanSil">Iban Listesini Sil</button>
                                                            <button type="button" class="btn btn-primary btn-sm mt-2" id="IbanGonder">Kaydet</button>
...
<script src="js/kartvizit.js" ></script>
</body>
</html>
